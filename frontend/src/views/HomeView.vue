...
<template>
  ...
  <div v-else>
    <div class="mb-8 text-center">
      <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">MiHub Personal</h1>
      <p class="mt-4 text-lg text-gray-600">Una app para organizar tareas y proyectos personales, de trabajo en Microsoft, YouTube, blog y colaboraciones externas en un solo lugar.</p>
